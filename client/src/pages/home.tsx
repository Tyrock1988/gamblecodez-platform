    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-slate-800">🎰 GambleCodez</h1>
            </div>
      ...
      <div className="bg-gradient-to-br from-blue-600 to-purple-700 text-white py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Welcome to GambleCodez</h2>
          <p className="text-xl text-blue-100 mb-8">Your ultimate destination for referral links, promos, and gaming connections</p>
      ...
      {/* US & Non-US Section */}
      <section id="us-nonus" className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-2xl font-bold text-slate-800">🇺🇸 US & Non-US List</h3>
      ...
      <section id="everywhere-faucet" className="py-12 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-2xl font-bold text-slate-800">🌍 Everywhere & Faucet List</h3>
      ...
      {/* Promos Section */}
      <section id="promos" className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-2xl font-bold text-slate-800">🔥 Featured Promos</h3>
      ...
      {/* Socials Section */}
      <section id="socials" className="py-12 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-2xl font-bold text-slate-800">📱 Social Links</h3>
